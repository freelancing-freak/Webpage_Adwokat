...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a class="nav-item nav-link active" href="#" onclick="$('#home').goTo();return false;">Strona główna</a>
                            ...
                            <a class="nav-item nav-link" href="#" onclick="$('#online-advice').goTo();return false;">Porada Online</a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item position-relative active" style="height: 80vh; min-height: 400px;">
                    <img class="position-absolute w-100 h-100" src="img/background.jpeg" style="object-fit: cover;" alt="">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a class="btn btn-primary py-3 px-5 mt-2" href="#" onclick="$('#about-me').goTo();return false;">Dowiedz się więcej</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-12 mt-4 mt-lg-0">
                    ...
                    <p>Oferujemy Państwu rzetelną i profesjonalną obsługę prawną osób fizycznych oraz podmiotów gospodarczych, reprezentowanie przed sądami wszystkich instancji i urzędami administracji państwowej oraz samorządowej w zakresie prawa cywilnego, prawa karnego, prawa gospodarczego, prawa pracy i ubezpieczeń społecznych, prawa rodzinnego, prawa spadkowego oraz prawa administracyjnego.</p>
                    <p>Zapewnimy kompleksowe doradztwo prawne na najwyższym, profesjonalnym poziomie, z jak najdalej idącym uwzględnieniem Państwa oczekiwań oraz sytuacji prawnej. Sporządzamy opinie i ekspertyzy prawne, profesjonalne projekty umów, pozwy, apelacje i inne pisma procesowe.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="services">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="service-item">
                        <img src="img/service_2.jpeg" alt="">
                        <div class="down-content">
                ...
                <div class="col-md-3">
                    <div class="service-item">
                        <img src="img/service_3.jpeg" alt="">
                        <div class="down-content">
                ...
                <div class="col-md-3">
                    <div class="service-item">
                        <img src="img/service_4.jpeg" alt="">
                        <div class="down-content">
                ...
                <div class="col-md-3">
                    <div class="service-item">
                        <img src="img/service_5.jpeg" alt="">
                        <div class="down-content">
                ...
                <div class="col-md-3">
                    <div class="service-item">
                        <img src="img/service_6.jpeg" alt="">
                        <div class="down-content">
                ...
                <div class="col-md-3">
                    <div class="service-item">
                        <img src="img/service_7.jpeg" alt="">
                        <div class="down-content">
                ...
                <div class="col-md-3">
                    <div class="service-item">
                        <img src="img/service_8.jpeg" alt="">
                        <div class="down-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 mt-4 mt-lg-0">
                    ...
                    <p>Koszt porady prawnej wynosi <b>od 50 zł do 250 zł</b> (cena zawiera podatek VAT), zależnie od czasu trwania porady i stopnia jej skomplikowania.</p>
                    <p>Koszt sporządzenia pozwu, pisma procesowego, apelacji, umowy, itp. wynosi od <b>100 zł</b> zależnie od stopnia jej skomplikowania.</p>
                    <p>Koszt powierzenia sprawy z udzieleniem pełnomocnictwa wynosi od <b>200 zł</b> zależnie od zakresu prac oraz stopnia skomplikowania.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                <div class="d-flex p-4">
                    <div>
                        ...
                        <br>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2497.3528540176326!2d22.55602421576049!3d51.24941227959358!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x472257680bf6fc57%3A0xfedc342f557d0cc0!2s3%20Maja%2C%2020-000%20Lublin!5e0!3m2!1spl!2spl!4v1582535621342!5m2!1spl!2spl" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                    </div>
                </div>
            </div>
            <style>
            ...
            <div class="col-lg-6 office-map">
                <div class="d-flex p-4">
                    <div>
                        ...
                        <br>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2468.459526123798!2d22.604845715780048!3d51.7794870796808!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4722193890b91d79%3A0x3d5f251f357be4c3!2sStefana+Kardyna%C5%82a+Wyszy%C5%84skiego+3A%2C+Radzy%C5%84+Podlaski!5e0!3m2!1spl!2spl!4v1467299428173" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="alert text-center cookiealert" role="alert">
        ...
        Ta strona używa plików cookies. &#x1F36A; Korzystając z niej wyrażasz zgodę na ich używanie. <a href="https://pl.wikipedia.org/wiki/HTTP_cookie" target="_blank">Dowiedz się więcej</a>
